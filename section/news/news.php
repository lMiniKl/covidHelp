...
<body>
	...
	<br><br>
	<h1 class="fluid" style="text-align: center;">Новости</h1>
	<br>
	<div class="Content">
		<div class="fluid col-md-12">
			<?php
				...
				$result = mysqli_query($con,"SELECT *FROM articles WHERE section = 'Новости' ORDER BY `articles`.`date_of_publication` DESC");
