...
<body>
	...
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Государственная помощь</li>
	</ol>
	<br><br>
	<h1 class="fluid" style="text-align: center;">Государственная помощь</h1>
	<br>
	<div class="Content">
		<div class="fluid col-md-12">
			<?php
				...
				$result = mysqli_query($con,"SELECT *FROM articles WHERE section = 'Государственная помощь' ORDER BY `articles`.`date_of_publication` DESC");
