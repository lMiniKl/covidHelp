...
<body>
	...
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Помощь FAQ</li>
	</ol>
	<br><br>
	<h1 class="fluid" style="text-align: center;">Помощь (FAQ)</h1>
	<br>
	<div class="Content">
		<div class="fluid col-md-12">
			<?php
				...
				$result = mysqli_query($con,"SELECT *FROM articles WHERE section = 'Помощь (FAQ)'");
